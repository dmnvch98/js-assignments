...
## Javascript Assignments  [![Build Status](https://travis-ci.org/dmnvch98/js-assignments.svg?branch=master)](https://travis-ci.org/dmnvch98/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'dmnvch98'` with your account name).
...
```
* Open https://github.com/dmnvch98/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/dmnvch98/js-assignments/builds).
